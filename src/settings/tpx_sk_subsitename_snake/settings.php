 ...
 * @endcode
 */
$settings['hash_salt'] = 'tri994wMCby96VyKRnk51-ihHlN2jkSJfYSdoG2Dkk6uVByojNR7YYjmJjAQ3TXFRVR53rDj7g';
...
/*
 * tpx_sk_sitename - ACQUIA SETTINGS
 */
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/tpx_sk_acquia_sitename/tpx_sk_acquia_subsitename-settings.inc';
}

if (!empty($_ENV['AH_SITE_ENVIRONMENT'])) {
  // Add environment value to variable.
  $settings['site_env'] = $_ENV['AH_SITE_ENVIRONMENT'];
  ...
  if (($_ENV['AH_SITE_ENVIRONMENT'] === 'dev' || $_ENV['AH_SITE_ENVIRONMENT'] === 'test')) {
...
/*
 * tpx_sk_sitename - CUSTOM ALTERATIONS
 */
$settings['config_sync_directory'] = realpath("$repo_root/src/config/tpx_sk_subsitename_snake/sync");

// Configure the application.
foreach (glob("$repo_root/src/settings/tpx_sk_subsitename_snake/*.settings.inc") as $file) {
  require_once $file;
}
